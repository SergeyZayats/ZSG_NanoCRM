...
<input name='username_login' placeholder='Введите имя пользователя' size='30'/> 
<br><br>
<input type='password' name='password_login' placeholder='Введите пароль пользователя' size='30'/>
<br><br>
